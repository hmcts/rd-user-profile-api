...
import uk.gov.hmcts.reform.userprofileapi.security.idam.IdamUserDetails;
...
public class IdamUserDetailsTest {
    ...
    private IdamUserDetails userDetails = new IdamUserDetails(accessToken, id, roles, emailAddress, forename, surname);
