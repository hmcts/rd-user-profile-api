...
public class UserProfileControllerTest {
    ...
    public void testretrieveUserProfiles() {
        ...
        userIds.add("1");
        userIds.add("2");
        UserProfilesRequest userProfilesRequest = mock(UserProfilesRequest.class);
        when(userProfilesRequest.getUserIds()).thenReturn(userIds);
        ResponseEntity<UserProfileDataResponse> responseEntity = sut.retrieveUserProfiles("false","true", userProfilesRequest);
