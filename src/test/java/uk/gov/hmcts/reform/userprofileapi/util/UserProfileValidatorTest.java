...
import static uk.gov.hmcts.reform.userprofileapi.util.UserProfileValidator.validateAndReturnBooleanForParam;
...
class UserProfileValidatorTest {
    ...
    @Test
    void test_isBlankOrSizeInvalid() {
    ...
    @Test
    void test_isSameAsExistingUserProfile() {
    ...
    @Test
    void test_validateCreateUserProfileRequest() {
        assertThatThrownBy(() -> UserProfileValidator.validateCreateUserProfileRequest(null))
                .isInstanceOf(NullPointerException.class);
    }

    @Test
    void test_validateCreateUserProfileRequest_no_exception_thrown() {
        UserProfileValidator.validateCreateUserProfileRequest(userProfileData);
    }

    @Test
    void test_validateCreateUserProfileRequest_no_exception_thrown_when_values_are_null() {
    ...
    @Test
    void test_validateCreateUserProfileRequest_ThrowsRequiredFieldMissingExceptionIfGetUserTypeIsNull() {
    ...
    @Test
    void test_validateCreateUserProfileRequest_ThrowsRequiredFieldMissingExceptionIfGetUserCategoryIsNull() {
    ...
    @Test
    void test_validateAndReturnBooleanForParam() {

        assertThat(validateAndReturnBooleanForParam("true")).isTrue();
        assertThat(validateAndReturnBooleanForParam("false")).isFalse();

        assertThatThrownBy(() -> validateAndReturnBooleanForParam(null))
                .isInstanceOf(RequiredFieldMissingException.class);

        assertThatThrownBy(() -> validateAndReturnBooleanForParam("invalid"))
                .isInstanceOf(RequiredFieldMissingException.class);
    }

    @Test
    void test_validateUserIds() {

        UserProfileDataRequest userProfileDataRequest = new UserProfileDataRequest(new ArrayList<>());
        assertThatThrownBy(() -> UserProfileValidator.validateUserIds(userProfileDataRequest))
                .isInstanceOf(RequiredFieldMissingException.class);
    }

    @Test
    void test_validateUserProfileDataAndUser() {
