...
public class UserProfileController {
    ...
    public ResponseEntity<UserProfileDataResponse> retrieveUserProfiles(@ApiParam(name = "showdeleted", required = true)@RequestParam (value = "showdeleted", required = true) String showDeleted,
                                                                        ...
                                                                        @RequestBody UserProfilesRequest userProfilesRequest) {
        ...
        UserProfileValidator.validateUserIds(userProfilesRequest);
        UserProfileDataResponse userProfileDataResponse =
                userProfileService.retrieveWithRoles(new UserProfileIdentifier(IdentifierName.UUID_LIST, userProfilesRequest.getUserIds()), showDeletedBoolean, rolesRequiredBoolean);
